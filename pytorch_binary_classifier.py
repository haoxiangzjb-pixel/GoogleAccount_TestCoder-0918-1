...
# Generate random filename and save this model
random_filename = create_random_filename()

# Save just the model class to the random filename
...
print(f"PyTorch binary classifier model saved as: {random_filename}")